...
const Faq: FC = () => {
  ...
  const faqItems = [
    { icon: ScanLine, questionKey: "faq.q1", answerKey: "faq.a1", question: t("faq.q1"), answer: t("faq.a1") },
    { icon: ScanLine, questionKey: "faq.q2", answerKey: "faq.a2", question: t("faq.q2"), answer: t("faq.a2") },
    { icon: ScanLine, questionKey: "faq.q3", answerKey: "faq.a3", question: t("faq.q3"), answer: t("faq.a3") },
    { icon: ScanLine, questionKey: "faq.q4", answerKey: "faq.a4", question: t("faq.q4"), answer: t("faq.a4") },
    { icon: ScanLine, questionKey: "faq.q5", answerKey: "faq.a5", question: t("faq.q5"), answer: t("faq.a5") },
    { icon: ScanLine, questionKey: "faq.q6", answerKey: "faq.a6", question: t("faq.q6"), answer: t("faq.a6") },
  ];
